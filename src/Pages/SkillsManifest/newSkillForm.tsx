    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="py-4">
                ...
                <Input
                    className={`mb-2 ${errors?.name ? "border-2 border-red-600" : "border-black"}`}
                ...
                <Input
                    className={`mb-2 ${
                        errors?.description ? "border-2 border-red-600" : "border-black"
                    }`}
                    {...register("description", { required: true })}
                />
            </div>
            <div className="justify-between grid grid-cols-4">
                <Button className="font-bold text-lg bg-red-500" onClick={close}>
                    Cancel
                </Button>
                <div className="col-span-2" />
                <Button
                    type="submit"
                    className="bg-green-600 font-bold flex items-center gap-2 text-lg"
                >
                    Add
                    <MdLibraryAdd />
                </Button>
